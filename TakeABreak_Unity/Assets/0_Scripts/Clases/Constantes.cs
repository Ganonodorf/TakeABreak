...
public class Constantes
{
    public class Dialogos
    {
        ...
        public const int RISA_1 = -2;
        public const int RISA_2 = -3;
        public const int RISA_3 = -4;
        public const int SILLON_MEDITAR = -2;
        public const int SILLON_LEVANTARSE = -3;

        public const int CONVERSACION_FINAL_RETOMAR_RISA_1 = 61;
        public const int CONVERSACION_FINAL_RETOMAR_RISA_2 = 76;
        public const int CONVERSACION_FINAL_RETOMAR_RISA_3 = 95;
    ...
    public class Tags
    {
        ...
        public const string TUMISMO = "TuMismo";
        public const string CABEZA_TUMISMO = "CabezaTuMismo";
        public const string BOCA_TUMISMO = "BocaTuMismo";
        public const string GUITARRA = "Guitarra";
    }
    ...
    public class ObjetosInteractuables
    {
        ...
        public static readonly Conversacion SILLON_CONVERSACION_SENTARSE = new Conversacion(
            ...
            frases: new Frase[9]
            {
                ...
                new Frase(ID: 5,
                          Texto: "Intenta seguir una respiración pausada, cuenta 5 segundos en tu cabeza para cada inspiración y exhalación. La marea te ayudará a llevar el tiempo.",
                          Interlocutor: InterlocutorEnum.Sillon,
                          Mostrar: true,
        ...
        frases: new Frase[132]
        {
                    ...
                    new Frase(ID: 12,
                    Texto: "¿Recuerdas que esto antes era imposible? Simplemente estar aquí, observando sin nada más que hacer. " +
                        "Estando.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 20,
                    Texto: "Jeje, vale vale... ¿Recuerdas cuando empezamos con la ansiedad? Sin poder respirar, siempre " +
                        "pensando, pensando, pensando... Era como tener en la cabeza una nube de preocupaciones irreales que " +
                        "te impiden actuar con naturalidad ni espontaneidad.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 21 }),
                    new Frase(ID: 21,
                    Texto: "Sí... Eso sí lo recuerdo. También recuerdo no ser capaz de decirte nada bueno, sólo te decía que " +
                        "todo iba a ser terrible, que tenías que hacer cosas que no querías, que todo iba a salir mal...",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 24,
                    Texto: "Eso es, Jose nos ayudó mucho a entender el porqué decías las cosas que decías y el significado real " +
                        "que había detrás. Cómo era tu funcionamiento.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 25 }),
                    new Frase(ID: 25,
                    Texto: "Si... Es verdad que muchas veces digo cosas sin pensar, antes te agobiaban mucho mis comentarios.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 27,
                    Texto: "Pues... Estuvimos un tiempo mejor, pero había algo que no terminaba de encajar en nosotros, no nos " +
                        "entendíamos y nos hacíamos daño.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 28 }),
                    new Frase(ID: 28,
                    Texto: "Y por eso fuimos a la segunda psicóloga, que nos ayudó entender como nos sentíamos el uno con el otro. " +
                        "Incluso aprendimos de dónde venían algunos comportamientos que teníamos en el presente.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 36,
                    Texto: "Pues la verdad... No lo sé. No sé si lo leí en algún sitio, se me ocurrió a mi mismo o qué. " +
                        "Sí que recuerdo el momento en el que te lo dije.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 37 }),
                    new Frase(ID: 37,
                    Texto: "Yo también, nos estábamos duchando y dijiste muy serio: \"Se acabó, acabo de pasarlo fatal y no puedo " +
                        "soportar que me sigas hablando así. Ten compasión de mí y háblame como si fueras Juan.\"",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 41,
                    Texto: "Pues si... Lo siento.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 42 }),
                    new Frase(ID: 42,
                    Texto: "Está bien, así pude forjar una actitud más fuerte tanto conmigo mismo como con el resto del mundo " +
                        "para que no me pisotearan.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 59,
                    Texto: "¿Sí? ¿Pero...? ¡Ah! Es verdad, que antes en vez de respirar y dejar pasar lo que te decía, me dabas " +
                        "bola jajaja.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { Constantes.Dialogos.RISA_1 }),
                    new Frase(ID: 61,
                    ...
                    new Frase(ID: 62,
                    Texto: "Y cuánta razón tenía... Dios... También me dijo muy seria: \"Tú no eres tu mente, tu ser y tu mente " +
                    ...
                    new Frase(ID: 64,
                    Texto: "Pues si... Y me costó mucho verlo e interiorizarlo, te tenía como la verdad absoluta, como que todo " +
                        "lo que decías era la realidad. A lo mejor al quitarle peso a tus comentarios hirientes y conventirlos en " +
                        "buenas palabras me pude crear una compasión tan fuerte.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 69,
                    Texto: "¿Y no te gustaría no haber pasado todo lo malo? Porque para haber conseguido esa compasión y esa " +
                        "tranquilidad, hubo que soportar mucha mierda. Los ataques de ansiedad no fueron bonitos...",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 70 }),
                    new Frase(ID: 70,
                    Texto: "No lo fueron, no... Pero aun así, estoy orgulloso y contento de haber sobrevivido a ello. " +
                        "Los malos momentos me hicieron conectar con un malestar tan profundo que me hizo valorar mucho las cosas " +
                        "buenas que tuve después y también fueron gasolina para querer estar mejor.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 74,
                    Texto: "Muy bien, -ejem-. Todos las experiencias de la vida, buenas y malas, ante el estertor de la muerte se " +
                        "perderán en el tiempo... Como un pedo en el viento...",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { Constantes.Dialogos.RISA_2 }),
                    new Frase(ID: 76,
                    Texto: "...",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 78,
                    Texto: "Sinceramente no me arrepiento de nada, volvería a vivir la misma vida sin dudarlo. Siento que pasar por " +
                        "un pozo de dolor y sufrimiento me ayudó a evolucionar hasta el punto donde estoy hoy.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 80,
                    Texto: "Claro, eso tampoco te lo voy a negar, me siento muy afortunado y privilegiado con lo que me ha dado la vida. " +
                        "La familia que tengo es maravillosa y eso sí que no lo pude ni lo puedo cambiar.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 82,
                    Texto: "Pues yo creo que la familia que hemos tenido es una cosa y a dónde hemos querido llegar con nuestra " +
                        "situación vital es otra.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 84,
                    Texto: "A ver, cuando lo estuvimos pasando tan mal, no veía un momento en el que fuera a estar bien. Simplemente " +
                        "yo acepté que la vida iba a ser así, siempre viviendo en mi mente, siempre con ansiedad crónica, " +
                        "siempre intraquilo e incapaz de ser feliz.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 85 }),
                    new Frase(ID: 85,
                    Texto: "Pero antes de empezar con la segunda psicóloga, me pregunté sinceramente: \"¿Porqué tengo tanta ansiedad?\" " +
                        "\"¿Quiero vivir toda mi vida así?\". Eso fue el motor para cambiar mi vida y mi relación conmigo mismo. " +
                        "Con la terapia podría conocerme mejor y descubrir la raíz de mi ansiedad.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 86 }),
                    new Frase(ID: 86,
                    Texto: "El decidir ir a terapia, enfrentarte a tus mierdas mas internas, a tu oscuridad, tus traumas, tu sombra... " +
                        "Es un camino duro que decidí tomar para estar mejor sabiendo perfectamente que iba a doler... ",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 87 }),
                    new Frase(ID: 87,
                    Texto: "Se puede vivir sin hacer este proceso, podría haber enterrado toda mi mierda en lo más profundo de mi ser, " +
                        "tener ataques de ansiedad de vez en cuando, estar siempre inquieto, con una máscara hacia el mundo, " +
                        "sin saber quién era... Vivir así es posible, pero no lo quería para mí.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 88 }),
                    new Frase(ID: 88,
                    Texto: "Es ciero que es un camino duro, pero tal como lo cuentas, suena un poco a: \"¿Estás mal? No estés mal.\"",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { Constantes.Dialogos.RISA_3 }),
                    new Frase(ID: 95,
                    ...
                    new Frase(ID: 98,
                    Texto: "Vale, lo tengo. Cuando una persona está muy mal y le dices \"No estés mal\" o \"No tengas ansiedad\" o " +
                        "\"Puedes estar bien, solo tienes que querer\" es de ser un gilipollas.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 102,
                    Texto: "Joder, vale, me explico. Cuando una persona tiene depresión, ansiedad muy fuerte o estados similares, " +
                        "ese tipo de comentarios no sirve. La persona necesita de atención psiquiátrica y psicológica y no hay más " +
                        "que hablar.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 103 }),
                    new Frase(ID: 103,
                    Texto: "Una vez que no está en esos umbrales, si la persona quiere estar mejor tiene que hacer un compromiso " +
                        "fuerte con ella misma. Tiene que saber que hay una parte de ella que no funciona correctamente, que no es " +
                        "perfecta y que ha cometido errores en la vida.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 104 }),
                    new Frase(ID: 104,
                    Texto: "Y para eso hace falta mucha confianza, porque cuando no estás bien, parece que no hay opción a estarlo. " +
                        "Y lo mejor es que todo el mundo puede.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 105 }),
                    new Frase(ID: 105,
                    Texto: "Pues sí... Y lo peor de todo es que suena como si fueras una puta taza de Mister Wonderful. \"Confía en la " +
                        "vida y todo irá bien\". Por eso parece que eres un gilipollas cuando dices estas cosas.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 107,
                    Texto: "Bueno, realmente hay que indagar un poco en la espiritualidad interna de cada uno. A mí me costó mucho ver " +
                        "y aceptar que esa palabra tenía cabida fuera de la religión.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 108 }),
                    new Frase(ID: 108,
                    Texto: "No te olvides tampoco del ego. Tener el ego bajo es importante.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 110,
                    Texto: "Si tu y yo no nos hubiéramos bajado unos tonitos, no habríamos podido alcanzar la calma. Confiar en la " +
                        "vida está genial, pero asumir que eres humano, que cometes errores, que te has hecho mucho daño, que estás " +
                        "sufriendo y que es posible que tengas algo de culpa... Es muy duro.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 114,
                    Texto: "Yo diría que eso es lo más complejo de todo, asumir que te has equivocado y que te has tratado mal en " +
                        "muchas ocasiones.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 117,
                    Texto: "Si... Y tienes que querer indagar en tu mierda y estar dispuesto a transitar por tus vivencias y emociones. " +
                        "Entrar en eso y salir se siente horrible y liberador a la vez, es acojonante.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 120,
                    Texto: "Eso es lo más bonito. Que parece que no, pero todo el mundo puede. Por eso te decía antes lo de querer " +
                        "hacerlo, si tienes confianza y compasión, puedes hacerlo.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    ...
                    new Frase(ID: 122,
                    Texto: "También es verdad, el entorno influye mucho, las relaciones personales tienen mucho peso en la vida de una " +
                        "persona. A lo mejor si no hubiéramos tenido el entorno que hemos tenido, no hubiéramos hecho este camino ni " +
                        "estaríamos aquí hoy.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 123 }),
                    new Frase(ID: 123,
                    Texto: "A lo mejor tampoco hubiéramos querido hacerlo, y también estaría bien. Cada persona tiene su propio camino " +
                        "y su forma de vivir la vida.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 124 }),
                    new Frase(ID: 124,
                    Texto: "Por supuesto, lo curioso es cómo esos caminos chocan cuando la gente cambia. Cuando comienzas un proceso de " +
                        "autoconocimiento y sanación, te das cuenta que mucha gente que hay a tu alrededor no te hace tanto bien como " +
                        "pensabas y no puedes evitar verlo. Es rarísimo y duro.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
                    SiguienteFrase: new int[1] { 125 }),
                    new Frase(ID: 125,
                    Texto: "Por eso también te decía antes que aunque el camino haya sido duro, merece la pena. Acabas cultivando " +
                        "relaciones que te respetan, que te tratan con amor y cariño y que quieren lo mejor para ti.",
                    Interlocutor: InterlocutorEnum.Jugador,
                    Mostrar: true,
                    ...
                    new Frase(ID: 130,
                    Texto: "Y que lo digas, al final no has respirado y has dejado pasar los pensamientos y ya está. Me he vuelto a " +
                        "salir con la mía jeje.",
                    Interlocutor: InterlocutorEnum.TuMismo,
                    Mostrar: true,
    ...
    public class Animacion
    {
        ...
        public class Banco
        {
            ...
            public const string SENTANDO_BANCO_IDLE = "Jugador_Sentado_Banco_Idle";
            public const string SENTANDO_BANCO_IDLE_CABEZA = "Jugador_Sentado_Banco_Cabeza";
            public const string SENTANDO_BANCO_IDLE_BOCA = "Jugador_Sentado_Banco_Boca";
            public const string SENTANDO_RIENDO = "Jugador_Riendo";
        }

        public class TuMismo
        {
            public const string IDLE = "TuMismo_Idle";
            public const string IDLE_CABEZA = "TuMismo_Cabeza";
            public const string IDLE_BOCA = "TuMismo_Boca";
            public const string RIENDO = "TuMismo_Riendo";
            public const string NADA = "TuMismo_Nada";
        }
