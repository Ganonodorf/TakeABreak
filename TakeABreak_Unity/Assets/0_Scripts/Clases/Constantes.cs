...
new Frase(ID: 21,
          Texto: "Sí... Eso sí lo recuerdo. Recuerdo no ser capaz de decirte nada bueno, sólo que todo era terrible, que hicieras cosas aunque no querías, que todo iba a salir mal...",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
...
new Frase(ID: 24,
          Texto: "Exacto, Jose nos ayudó mucho a entender el porqué decías las cosas que decías y el significado real que había detras. Vamos, cómo funcionabas por dentro.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 28,
          Texto: "Y por eso fuimos a la segunda psicóloga, que nos ayudó más a entender como nos sentíamos el uno con el otro e incluso de dónde venían algunos comportamientos del presente.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 30,
          Texto: "Eso es. No podía dejar que me siguieras hablando tan mal, tenía que ponerte freno de una vez por todas.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 35,
          Texto: "Si... ¿Y porqué decidiste hacer eso?",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
          SiguienteFrase: new int[1] { 36 }),
new Frase(ID: 36,
          Texto: "Pues la verdad... No lo sé. No sé si lo leí en algún sitio, se me ocurrió a mi mismo o qué, pero recuerdo perfectamente el momento.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 48,
          Texto: "Es cierto, estaba esperando a que te acordaras.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 64,
          Texto: "Y cuánta razón tenía... Dios... También me dijo que yo no era mi mente, que eso si que fue fuerte...",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
          SiguienteFrase: new int[1] { 65 }),
new Frase(ID: 65,
          Texto: "De eso si me acuerdo muy bien. Te hizo ver que todo lo que yo decía no era real.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
          SiguienteFrase: new int[1] { 66 }),
new Frase(ID: 66,
          Texto: "Pues si... Y me costó eh, te tenía como la verdad absoluta, como que todo lo que decías era la realidad. A lo mejor por eso me pude crear una compasión tan fuerte.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 72,
          Texto: "No lo fueron, no... Pero aun así, estoy orgulloso y contento de haber sobrevivido a ello. Me hicieron conectar con un malestar tan grande que me hizo valorar mucho lo bueno que tuve después.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 74,
          Texto: "Jeje, ¿y quién te dice que no lo he hecho?",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
          SiguienteFrase: new int[1] { 75 }),
new Frase(ID: 75,
          Texto: "Ya ya ya, no cambies de tema y sigue contándome.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
...
new Frase(ID: 88,
          Texto: "A ver, cuando lo estuvimos pasando tan mal, no veía un momento en el que fuera a estar bien. Yo acepté que la vida iba a ser así, con ansiedad crónica, siempre en mi mente e incapaz de ser feliz. Pero antes de empezar con la segunda psicóloga, me pregunté: ¿Porqué tengo tanta ansiedad? Y eso fue el motor que me hizo ir con ella, porque con la Gestalt sentía que podía conocerme mejor, saber de dónde venía mi ansiedad, porqué era ansioso en el presente y cómo podía estar mejor. Y por ello también fuimos luego al tercer psicólogo que también era Gestalt. El decidir ir a terapia, enfrentarte a tus mierdas mas internas, a tu oscuridad, tu sombra, tus traumas... Es un camino duro que decidí tomar para estar mejor sabiendo perfectamente que iba a doler... Podría haber enterrado todo eso en lo más profundo de mi ser, tener ataques de ansiedad de vez en cuando, seguir inquieto y demás... Vivir así es posible, pero no lo quería para mí y estar mejor.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 104,
          Texto: "Joder, a ver, déjame explicarme. Cuando una persona tiene depresión, ansiedad muy muy fuerte o estados similares ese tipo de comentarios no sirve. La persona necesita de atención psiquiátrica y psicológica y no hay más que hablar. Pero una vez que no está en esos umbrales, si la persona quiere estar mejor tiene que hacer un compromiso fuerte con ella misma para hacerlo. ¿Y sabes cuál es una parte muy importante de todo esto?",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
          SiguienteFrase: new int[1] { 105 }),
new Frase(ID: 105,
          Texto: "La confianza. Que se me hayan olvidado algunas cosas no significa que no estemos juntos siempre, no me hagas preguntas retóricas.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
...
new Frase(ID: 111,
          Texto: "Si tu y yo no nos hubiéramos bajado unos tonitos, no habríamos podido alcanzar la calma. Confiar en la vida está genial, pero asumir que eres humano, que cometes errores, que te has hecho mucho daño, que estás sufriendo y que es posible que tengas algo de culpa... Pues es muy duro también.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
...
new Frase(ID: 117,
          Texto: "Por supuesto, no me malinterpretes, curar las heridas que te ha provocado la gente es muy duro también.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
          SiguienteFrase: new int[1] { 118 }),
new Frase(ID: 118,
          Texto: "Si... Y tienes que querer verlo todo, estar dispuesto a transitar por esas emociones y salir de ahí.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
          SiguienteFrase: new int[1] { 119 }),
new Frase(ID: 119,
          Texto: "Exacto, y para ello tienes que querer estar mejor, tener una convicción dentro de tí que te permita hacer ese viaje.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
          SiguienteFrase: new int[1] { 120 }),
new Frase(ID: 120,
          Texto: "Y todo el mundo puede hacerlo.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
...
new Frase(ID: 122,
          Texto: "Ya... Pero no todo el mundo tiene eso.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
          SiguienteFrase: new int[1] { 123 }),
new Frase(ID: 123,
          Texto: "También es verdad eso, el entorno influye mucho, tus relaciones personales tienen mucho peso en la vida de una persona. A lo mejor si no hubiéramos tenido el entorno que hemos tenido, no estaríamos aquí hoy.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
          SiguienteFrase: new int[1] { 124 }),
new Frase(ID: 124,
          Texto: "Pues a lo mejor no eh, a lo mejor no... Y también se pierden amistades por el camino y no puedes hacer nada.",
          Interlocutor: InterlocutorEnum.Jugador,
          Mostrar: true,
          SiguienteFrase: new int[1] { 125 }),
new Frase(ID: 125,
          Texto: "También... Cuando comienzas un proceso de autoconocimiento y sanación, te das cuenta que mucha gente que hay a tu alrededor no te hace tanto bien como pensabas y no puedes evitar verlo. Es duro.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
...
new Frase(ID: 131,
          Texto: "Y que lo digas, al final no has sido observador de los pensamientos y ya está. Me he vuelto a salir con la mía jeje.",
          Interlocutor: InterlocutorEnum.TuMismo,
          Mostrar: true,
